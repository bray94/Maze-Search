...
public class Maze 
{
	...
	*/
	...
	public Queue <MazeCell> nodesExpanded = new LinkedList<MazeCell>();
	...
	public void addNodesExpanded(MazeCell curr){
		nodesExpanded.add(curr);
	}
	...
	public void solve()
	{
		//solution = SearchMethods.breadthFirstSearch(this);
		//solution = SearchMethods.depthFirstSearch(this);
		//solution = SearchMethods.greedyBestFirstSearch(this);
		solution = SearchMethods.aStarSearch(this);
		Animation.drawMaze(this, solution);
	}
	...
	public static void main(String []args)
	{
		...
		Maze mediumMaze = new Maze("src/mp1/SmallTurns.txt");
		mediumMaze.solve();
